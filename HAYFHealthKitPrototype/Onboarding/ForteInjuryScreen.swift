...
struct ForteInjuryScreen: View {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(alignment: .leading, spacing: 0) {
                        ...
                        ForteTextArea(
                            ...
                            placeholder: "Knee pain on descents, shoulder discomfort overhead, returning from an ankle issue, or anything Forte should plan around…",
                            text: $injuryNotes,
                            characterLimit: 220
                        )
                    }
    ...
    private var progressHeader: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            HStack(spacing: 12) {
                ...
                HStack(spacing: 8) {
                    ForteInjuryHeaderButton(systemName: "arrow.left", action: onBack)
                        .accessibilityLabel("Back")

                    ForteInjuryHeaderButton(systemName: "xmark", action: onExit)
    ...
    private var hero: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Text("Minor discomforts can change the plan.\nForte will adjust load, exercise, or progression.")
    ...
    private var continueAction: some View {
        ...
        .buttonStyle(ForteInjuryPrimaryButtonStyle())
        .accessibilityHint("Shows the next onboarding step.")
        .padding(.horizontal, 24)
        .padding(.top, 8)
        .padding(.bottom, 18)
...
private struct ForteInjuryHeaderButton: View {
...
private struct ForteInjuryPrimaryButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            .foregroundStyle(Color.white)
            .background(configuration.isPressed ? ForteColor.indigoDeep : ForteColor.indigo)
            .clipShape(Capsule())
